...
VM_SYSTEM_MOUNT_POINT_SYMLINK := $(TARGET_OUT_VENDOR)/vm-system
$(VM_SYSTEM_MOUNT_POINT_SYMLINK): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating $(VM_SYSTEM_MOUNT_POINT_SYMLINK)"
...
ALL_DEFAULT_INSTALLED_MODULES += $(ASUSFW_MOUNT_POINT) $(VM_SYSTEM_MOUNT_POINT_SYMLINK) $(FACTORY_MOUNT_POINT_SYMLINK)
