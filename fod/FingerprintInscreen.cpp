...
#define GLOBAL_HBM_MODE_PATH "/proc/hbm_mode"
#define GLOBAL_HBM_MODE_ON "2"
...
Return<void> FingerprintInscreen::onPress() {
    ...
    android::base::WriteStringToFile(GLOBAL_HBM_MODE_ON, GLOBAL_HBM_MODE_PATH);
...
Return<void> FingerprintInscreen::onRelease() {
    ...
    android::base::WriteStringToFile(GLOBAL_HBM_OFF, GLOBAL_HBM_MODE_PATH);
